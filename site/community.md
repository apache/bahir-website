...
* Consider tracking down the bug yourself in the Bahir's source and submitting a patch along with your bug report. This is a great time saver for the Bahir developers and helps ensure the bug will be fixed quickly.
